...
(function () {
    ...
    /* ---------- Categorias ---------- */
    const CATEGORIAS = {
        'linha-institucional': { rotulo: 'Institutional',   cor: 'vermelho' },
        'massa-recheada':      { rotulo: 'Filled',        cor: 'azul'     },
        'massa-fresca':        { rotulo: 'Fresh',          cor: 'vermelho' },
        'linha-seca':          { rotulo: 'Dry Line',      cor: 'azul'     },
        'pao-alho':            { rotulo: 'Garlic Bread',     cor: 'vermelho' }
    };
